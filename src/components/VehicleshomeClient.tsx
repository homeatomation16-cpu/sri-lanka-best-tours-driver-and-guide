...
const languageDrivers = ["English Speaking", "French Speaking", "German Speaking", "Hindi Speaking", "Spanish Speaking", "Italian Speaking", "Arabic Speaking", "Russian Speaking"];
    ...
    <section className="py-16 sm:py-24 bg-linear-to-b from-white to-orange-50/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-16">
          <p className="text-orange-500 font-bold uppercase tracking-[0.3em] text-[10px] mb-4">{t("whatsNew")}</p>
          <h2 className="font-serif text-4xl md:text-6xl font-bold text-zinc-900 mb-8 leading-tight">{t("heading")}</h2>
          ...
          <p className="max-w-4xl mx-auto text-zinc-500 text-lg leading-relaxed italic font-serif">&quot;{t("desc")}&quot;</p>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-64 w-full overflow-hidden bg-gray-100">
                  ...
                  />
                  <div className="absolute top-6 left-6 bg-orange-600 text-white px-4 py-2 rounded-2xl font-bold shadow-lg text-sm tracking-tight">{v.price}/day</div>
                  <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold text-orange-600 uppercase tracking-widest shadow-sm">{v.type}</div>
                </div>

                {/* Card Content */}
                <div className="p-8 flex flex-col flex-1">
                  <h4 className="text-2xl font-bold text-zinc-900 mb-4 group-hover:text-orange-600 transition-colors">{data.name}</h4>
                  ...
                  <div className="mt-8 flex items-center justify-between">
                    <span className="text-zinc-300 text-[9px] font-black uppercase tracking-[0.2em]">Sri Lanka Best Tours</span>
